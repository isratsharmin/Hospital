    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        echo "<table border='1' cellpadding='3'>";
         echo "<tr><th>ID</th><th>Name</th><th>Category</th><th>Description</th><th>Quantity </th><th>Quantity </th><th>Delete</th></tr>";
        ...
        while($row = mysql_fetch_array( $result )) {
				...
				<td><a href="delete_stock.php?stock_id=<?php echo $row['med_id']?>"><img src="../images/delete-icon.jpg" width="24" height="24" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
        ...
        <div id="content_2" class="content">  
		 ...
		 <?php echo $message;
			  echo $message1;
			  ?>
			<form name="myform" onsubmit="return validateForm(this);" action="admin_medicine.php" method="post" >
			<table width="420" height="106" border="0" >	
				<tr><td align="center"><input name="med_name" type="text" style="width:170px" placeholder="Drug Name" required="required" id="med_name" /></td></tr>
