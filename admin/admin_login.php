...
break;
case 'Doctor':
$result=mysql_query("SELECT doc_id,doc_username FROM doctor WHERE doc_username='$username' AND doc_pass='$password'");
$row=mysql_fetch_array($result);
if($row>0){
session_start();
$_SESSION['doc_id']=$row[0];
$_SESSION['doc_username']=$row[1];
...
<div id="content">
<div id="header">
<h1 style="text-align:center;position:absoulate; padding-top:30px;">Admin Panel</h1>
</div>
<div id="main">
  ...
  <section class="container">
     ...
     <div class="login">
	 <img src="../images/images.png" style="width:150px;">
      <h1>Login here</h1>
	  $message
